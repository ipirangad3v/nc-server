package com.thondigital.nc.data.database.table

import com.thondigital.nc.data.dao.BlogsDao
import com.thondigital.nc.data.entity.EntityBlog
...
object Blogs : IntIdTable(), BlogsDao {
    ...
    override suspend fun searchByQuery(query: String): List<BlogDataModel> =
        newSuspendedTransaction(Dispatchers.IO) {
            EntityBlog.find {
    ...
    override suspend fun isBlogAuthor(
        blogId: Int,
        userId: Int,
    ): Boolean =
        newSuspendedTransaction(Dispatchers.IO) {
    ...
    override suspend fun exists(blogId: Int): Boolean =
        newSuspendedTransaction(Dispatchers.IO) {
